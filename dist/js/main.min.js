$((function(){$(".header__nav li a").on("click",(function(e){$(".header__nav li a").removeClass(),e.target.classList.add("active")})),$(".slider-items").slick({infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!0,autoplaySpeed:5e3,speed:1e3})})),
/*!
